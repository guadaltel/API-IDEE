...
module.exports = {
  mode: 'production',
  entry: {
    'viewmanagement.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`viewmanagement-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
