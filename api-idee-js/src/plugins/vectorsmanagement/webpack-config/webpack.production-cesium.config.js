...
module.exports = {
  mode: 'production',
  entry: {
    'vectorsmanagement.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`vectorsmanagement-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
