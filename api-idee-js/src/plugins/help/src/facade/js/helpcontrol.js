    ...
    Promise.all(this.helpsContent).then((resultsHelps) => {
      const html = IDEE.template.compileSync(helps, {
        ...
        vars: {
          ...
          downloadPDFimg: `${IDEE.config.RECURSOS_ESTATICOS}/imagenes/logos/file-pdf.svg`,
          zoom1: `${IDEE.config.RECURSOS_ESTATICOS}/Simbologia/svg/controles_complementos/help/magnify_on.svg`,
          zoom2: `${IDEE.config.RECURSOS_ESTATICOS}/Simbologia/svg/controles_complementos/help/magnify_off.svg`,
          translations: {
