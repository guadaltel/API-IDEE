...
module.exports = {
  mode: 'production',
  entry: {
    'queryattributes.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`queryattributes-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
