...
```html
 <link href="https://componentes.cnig.es//plugins/selectionzoom/selectionzoom.ol.min.css" rel="stylesheet" />
 <script type="text/javascript" src="https://componentes.cnig.es//plugins/selectionzoom/selectionzoom.ol.min.js"></script>
```
...
Ejemplo:
```html
 <link href="https://componentes.cnig.es//plugins/selectionzoom/selectionzoom-1.0.0.ol.min.css" rel="stylesheet" />
 <script type="text/javascript" src="https://componentes.cnig.es//plugins/selectionzoom/selectionzoom-1.0.0.ol.min.js"></script>
```
