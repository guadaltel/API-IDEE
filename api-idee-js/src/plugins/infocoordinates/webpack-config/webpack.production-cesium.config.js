...
module.exports = {
  mode: 'production',
  entry: {
    'infocoordinates.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`infocoordinates-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
