...
module.exports = {
  mode: 'production',
  entry: {
    'rastermanagement.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`rastermanagement-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
