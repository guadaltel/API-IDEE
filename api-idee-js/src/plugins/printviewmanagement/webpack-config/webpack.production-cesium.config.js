...
module.exports = {
  mode: 'production',
  entry: {
    'printviewmanagement.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`printviewmanagement-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
