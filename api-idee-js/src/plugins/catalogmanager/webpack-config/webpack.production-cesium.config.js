...
module.exports = {
  mode: 'production',
  entry: {
    'catalogmanager.cesium.min': path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
    [`catalogmanager-${pjson.version}.cesium.min`]: path.resolve(__dirname, '..', 'src', 'index-cesium.js'),
  },
  output: {
